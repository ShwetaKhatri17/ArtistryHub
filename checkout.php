...
<script src="https://www.paypal.com/sdk/js?client-id=AXPDBE3TusPzJ7Q8fVWjEc3ayMa0LElVMDSkT_vagGRBalKpx9BV-_Rhttb4IxVUE5VTPoFkjUqhYzMh&currency=USD"></script>
<!--<script src="https://www.paypal.com/sdk/js?client-id=AfGMIZlB0LAAwD4KU9YFnQa1LWEsrR_0v60sJUMY7W_UrCvFjFMpDB4uQLu1DrsVYhIrndECJC6H2ctB&currency=USD"></script> -->
...
<script>
      ...
      paypal.Buttons({
        ...
        onApprove: (data, actions) => {
            ...
            //element.innerHTML = '<h3>Thank you for your payment 1</h3>';
